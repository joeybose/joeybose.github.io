...
$$
\begin{equation}
    \textstyle x' \in \argmax_{x'\in \mathcal{X}}\ell(f(x'),y) \,, \quad \text{s.t.} \quad d(x,x') \leq \epsilon \,.
\end{equation}
$$
...
![EX1]({{ "../assets/Poly-1.png" | absolute_url }}){: style="display: block; margin: auto;"}
...
![EX1]({{ "../assets/F_entropy-1.png" | absolute_url }}){: style="display: block; margin: auto;"}
