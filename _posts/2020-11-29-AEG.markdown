...
In this Blogpost we focus on a new kind of threat model that appears in a new
...
\begin{equation}
    ...
    \qquad \textnormal{where $$\ell$$ is the cross entropy loss.}
\end{equation}
$$
...
![EX1]({{ "../assets/AEG_arch.png" | absolute_url }}){: style="display: block; margin: auto;"}
